...
export const MenuBarWrapper = styled.div<{
  ...
  --bgColor: ${({ theme, bgColorLight, bgColorDark }) =>
    theme.darkMode ? bgColorDark || Color.neutral0 : bgColorLight || Color.neutral0};
  --bgDropdownColor: ${({ theme, bgDropdownColorLight, bgDropdownColorDark }) =>
    theme.darkMode ? bgDropdownColorDark || Color.neutral0 : bgDropdownColorLight || Color.neutral0};
  --color: ${({ theme, colorLight, colorDark }) =>
    theme.darkMode ? colorDark || Color.neutral98 : colorLight || Color.neutral100};
  --borderRadius: 28px;
  --blur: 16px;

  // Elements
  --defaultFill: ${({ theme, defaultFillLight, defaultFillDark }) =>
    theme.darkMode ? defaultFillDark || Color.neutral60 : defaultFillLight || 'rgb(255 255 255 / 50%)'};
  --activeBackground: ${({ theme, activeBackgroundLight, activeBackgroundDark }) =>
    theme.darkMode ? activeBackgroundDark || Color.neutral30 : activeBackgroundLight || Color.neutral20};
  --activeFill: ${({ theme, activeFillLight, activeFillDark }) =>
    theme.darkMode ? activeFillDark || Color.neutral100 : activeFillLight || Color.neutral100};
  --hoverBackground: ${({ theme, hoverBackgroundLight, hoverBackgroundDark }) =>
    theme.darkMode ? hoverBackgroundDark || Color.neutral20 : hoverBackgroundLight || Color.neutral30};
