...
import { CowAnalyticsProvider, CowAnalytics, AnalyticsContext, EventOptions, OutboundLinkParams } from '@cowprotocol/analytics'
...
// No-op analytics implementation for CoW Foundation - no tracking
const noOpAnalytics: CowAnalytics = {
  setUserAccount: () => {},
  sendPageView: () => {},
  sendEvent: () => {},
  sendTiming: () => {},
  sendError: () => {},
  outboundLink: (params) => params.hitCallback(),
  setContext: () => {},
}
          ...
          <>
            <ApolloProvider client={apolloClient}>
              <WithLDProvider>
                <ThemeProvider>
                  <GlobalStyles />
                  <CowAnalyticsProvider cowAnalytics={noOpAnalytics}>{children}</CowAnalyticsProvider>
                </ThemeProvider>
              </WithLDProvider>
            </ApolloProvider>
          </>
